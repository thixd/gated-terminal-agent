# 🖥️ Gated-Terminal-Agent: Enhancing CLI Agents with Gated Attention & RL
...
We evaluate the agent using **TerminalBench 2.0**, a rigorous suite of 89 containerized tasks reflecting professional engineering workflows (e.g., reverse-engineering binaries, configuring networked services, and resolving dependency conflicts).
...
## 🛠️ Implementation Guide (Local Execution)
